...
## [3.6.0](https://github.com/comfino/PrestaShop/tree/3.6.0) (2026-08-07)
...
- Security: redirect addresses returned by the API are validated before use, server variables are sanitized before being logged, and the widget configuration is encoded so that no shop setting can break out of the page markup.
