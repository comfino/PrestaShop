...
require_once _PS_MODULE_DIR_ . 'comfino/src/Order/Cart/CartItem.php';
require_once _PS_MODULE_DIR_ . 'comfino/src/Order/Cart/Product.php';
...
final class OrderManager
{
     ...
     * @throws \Exception
     */
    public static function getShopCart(\Cart $cart)
    {
     ...
     * @return Cart
     */
    public static function getShopCartFromOrder(\Order $order)
    {
