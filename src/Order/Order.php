...
require_once _PS_MODULE_DIR_ . 'comfino/src/Order/OrderInterface.php';
require_once _PS_MODULE_DIR_ . 'comfino/src/Order/LoanParametersInterface.php';
require_once _PS_MODULE_DIR_ . 'comfino/src/Api/CartInterface.php';
require_once _PS_MODULE_DIR_ . 'comfino/src/Order/CustomerInterface.php';
...
use Comfino\Order\LoanParametersInterface;
use Comfino\Order\OrderInterface;
